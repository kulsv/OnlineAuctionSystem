...
<? }?>
          ...
          <table width="338" border="1">
            ...
            <tr>
              <td>Enter New Damage </td>
              <td bgcolor="#F2E7E1"><input type="text" name="new1" id="new1" value="<? echo $type;?>"/></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td bgcolor="#F2E7E1"><input type="submit" name="button2" onclick="validate222();" id="button2" value="Edit" /></td>
            </tr>
          </table>
          <p>&nbsp;</p>
        </div>
