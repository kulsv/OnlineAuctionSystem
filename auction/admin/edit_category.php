...
return valid;
      ...
      <form action="category_update.php" method="post" name="form1" id="form1" onsubmit="return validate (this);">
...
if($sa=="success")
 ...
 <? if($f=='s')
 {?>
                <span class="style2">Category editted Succesfully</span></p>
<? }?>
</div>
                <div  style=" border:#000000;  overflow:auto;">
                <table width="433" border="1" align="center" cellpadding="2" cellspacing="2">
                  <tr>
                    <td colspan="2" bgcolor="#E4EDEC"><strong>Edit Category </strong></td>
                  </tr>
                  <tr>
	...
	?>
                  ...
                  <tr>
                    <td width="30%" height="26" bgcolor="#E4EDEC"><strong>Select Sub Category:</strong></td>
                    <td><div id="state_div">
             <div align="left">
             <? $query4="select * from subcat where catid = '".$id ."' ";
			 $result4=mysql_query($query4); ?>
             </div>
         </div></td>
                  </tr>
                  <tr>
                    <td width="30%" height="27" bgcolor="#E4EDEC">Enter New Sub Category:</td>
                    <td><label>
                    <input type="text" name="upd" id="upd" />
                    </label></td>
                  </tr>
                  <tr>
                    ...
                    <td bgcolor="#E4EDEC"><label>
                      <div align="center">
                        <input type="submit" name="Submit" onclick="return validate9999();"  value="Update" />
                      </div>
                    </label></td>
                  </tr>
              </table></td>
