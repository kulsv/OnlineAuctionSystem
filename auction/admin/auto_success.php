...
{
$query1="insert into tbl_automobile_details (auto_year,auto_make,auto_model,auto_facility,auto_saledate,auto_odometer,auto_title,auto_damage,auto_currentbid,auto_image,auto_video) values( '".$_POST['txt_auto_year']."','".$_POST['txt_auto_make']."','".$_POST['txt_auto_model']."','".$_POST['txt_auto_facility']."','".$_POST['txt_auto_saledate']."','".$_POST['txt_auto_odometer']."','".$_POST['txt_auto_title']."','".$_POST['txt_auto_damage']."','".$_POST['txt_auto_currentbid']."','".$_POST['txt_auto_image']."','".$_POST['txt_auto_video']."')";
$result=mysql_query($query1);
if($result)
$msg="Automobile details successfully entered 1";
else
$msg="Details entering failed !";
}
}
?>
