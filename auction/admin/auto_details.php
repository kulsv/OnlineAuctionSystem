...
<form name="form3" method="post" action="automobile_details_success.php"  enctype="multipart/form-data" onsubmit="return validate9999();">
  <table width="377" border="1" align="center" cellpadding="2" cellspacing="2">
    ...
    <tr>
      <td width="135" bgcolor="#E4EDEC">&nbsp;</td>
      <td width="110" bgcolor="#E4EDEC"><label>
      
        <? $query3="select distinct uid from cuser";
	           $result2=mysql_query($query3);?>
          <select name="uid" id="uid" class="new1">
             
            <? while($row2=mysql_fetch_array($result2))
 { ?>
			 
              
               <option value="<? echo $row2['uid']; ?>" ><? echo $row2['uid']; ?></option>
               
             <? } ?>
             </select>
      </label></td>
      <td width="110" rowspan="2" bgcolor="#E4EDEC">&nbsp;</td>
      <td width="222" rowspan="2" bgcolor="#E4EDEC">&nbsp;</td>
    </tr>
    <tr>
      <td width="135" bgcolor="#E4EDEC">Year</td>
      <td bgcolor="#E4EDEC"><select name="txt_auto_year" >
        <?php
	    $currYear = date('Y');
    ...
    <tr>
      <td bgcolor="#E4EDEC">Make &amp; Model</td>
      <td bgcolor="#E4EDEC"><div id="state_div">
          <select name="txt_auto_make" id="txt_auto_make" class="new1">
            <option value="sub">Select</option>
          </select>
         <!-- <input type="text" name="txt_auto_make" id="txt_auto_make" />-->
      </div>
      <div id="model_div"></div></td>
      <td rowspan="2" bgcolor="#E4EDEC">&nbsp;</td>
      <td rowspan="2" bgcolor="#E4EDEC"></td>
    </tr>
    <tr>
      <td bgcolor="#E4EDEC">&nbsp;</td>
