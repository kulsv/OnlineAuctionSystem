...
function send()
{
window.location = "customvideoedit.php"
  ...
  <tr>
                  ...
                  <tr>
                    <td align="left" class="body_padding"><table width="736" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <form name="deleteform" action="deletevideotask.php" method="post">
    ...
    <td height="28" align="center"><? $id=$_REQUEST['id'];
	 include("conn.php");
						   ...
						   ?>
                           <p class="style1"><span class="style5">Do you want to delete the video named &nbsp;<? echo $name; ?></span></p>
                           <p class="style1"><br />
