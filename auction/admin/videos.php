...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="174"  bgcolor="#F2E7E1"><span class="style1">Title</span></td>
    <td width="53" ><span class="style1">Category</span></td>
    
    <td width="64" ><span class="style1">Video</span></td>
    <td width="50" ><span class="style1">Staus</span></td>
    <td width="79" ><span class="style1">Time</span></td>
    <td width="94" ><span class="style1">Options</span><span class="style1"></span></td>
    </tr><?
  include("conn.php");
						   $query="select * from autopost order by id desc";
