...
<body>
  ...
  <table width="831" border="0" align="center" >
    ...
    <tr bgcolor="#F2E7E1">
      <td width="87"  bgcolor="#F2E7E1"><span class="style6">Stock</span></td>
      <td width="49" ><span class="style6">Year</span></td>
      <td width="100" ><span class="style6">Title</span></td>
      <td width="59" ><span class="style6">Make</span></td>
      <td width="62" ><span class="style6">Mode</span><span class="style1">l</span></td>
      <td width="63" class="style6" >Max Bid</td>
      <td width="60" class="style6" >Asking Price</td>
      <td width="97" class="style6" >Status</td>
      <td width="206" class="style6" >Reset to auction</td>
    </tr>
    <?
  include("conn.php");
    ...
    <tr bgcolor="#E4EDEC">
      ...
      <td>
    <? if($auval>=$minbid) { ?>
      <p class="style3">Approved<a href="view2.php?id=<? echo $u_id ;?>&bid=<? echo  $auval;?>">View</a></p>
      <? }
	  else
	  { ?>
      <p class="style4">NotApproved<a href="contact_details.php?id=<? echo $id; ?>&own=<? echo  $auval;?>&max=<? echo  $minbid;?>">Contact Owner</a></p>
      <? } ?>      </td>
