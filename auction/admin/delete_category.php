...
return valid;
      ...
      <form action="category_delete.php" method="post" name="form1" id="form1" onsubmit="return validate (this);">
...
<? }?>
	...
	?>
			 ...
			 $result4=mysql_query($query4); ?>
                  ...
                  <tr>
                    <td width="30%" height="27" bgcolor="#E4EDEC">:</td>
                    <td><label>
                      <input type="submit" name="Submit" onclick="return validate9999();"  value="Delete" />
                    </label></td>
                  </tr>
                  <tr>
