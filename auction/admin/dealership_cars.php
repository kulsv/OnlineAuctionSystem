...
<table width="841" border="0" align="center" >
  ...
  <tr bgcolor="#F2E7E1">
    ...
    <td width="122"><span class="style1">Options</span><span class="style1"></span></td>
  </tr>
  <?php
	       include("conn.php");
		   
		   $query="SELECT * FROM tbl_automobile_details where usertype ='DEALER SHIP' ORDER BY auto_id DESC";
