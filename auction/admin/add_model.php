...
return valid;
      ...
      <form action="insert_model.php" method="post" name="form1" id="form1" onsubmit="return validate (this);">
...
if($sa=="success")
 ...
 <? if($f=='s')
 {?>
                <span class="style2">Category Added Succesfully</span></p>
<? }?>
<? if($f=='f')
 {?>
                <span class="style2">Category Not Added Succesfully</span></p>
<? }?>
</div>
                <div  style=" border:#000000;  overflow:auto;">
                <table width="433" border="1" align="center" cellpadding="2" cellspacing="2">
                  <tr>
                    <td colspan="2" bgcolor="#E4EDEC"><strong>Add Model</strong></td>
                  </tr>
                  <tr>
             ...
             <div align="left">
               <select name="txt_auto_make" id="txt_auto_make" class="new1">
                 <option value="sub">Select</option>
                  ...
                  <tr>
                    <td width="30%" height="27" rowspan="2" bgcolor="#E4EDEC">Enter Model:</td>
                    <td><label>
                ...
                <input type="text"  name="txt_auto_model" class="new1" id="txt_auto_model"  />
                  ...
                  <tr>
                    ...
                    <td bgcolor="#E4EDEC"><label>
                      <div align="center">
                        <input type="submit" name="Submit" onclick="return validate9999();"  value="Add" />
                      </div>
                    </label></td>
                  </tr>
            </table></td>
