...
<form name="card_details" action="form.php" method="post" id="form_card_details" onSubmit="return validateForm()">
<span>
...
<div id="apDiv12"><span>AMOUNT: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="amount" id="amount" value=" <?php echo 'product amount'; ?>" readonly> </span></div>
...
if(!(isset($_POST['submit_card_details']))){
		...
		{		
			...
			$Payment = new Payment;
			$flag = $Payment->verify_card($cardnumber , $validity ,$cardtype		);
